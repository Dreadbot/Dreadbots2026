...
public class Constants {
    ...
    //     public static final double MAX_ANGLE = 2.0;
    // }
    ...
    //     0.0);//new Translation2d(-0.1518, -0.210); // +X = -Y in CAD +Y = +X in CAD (offset from center)
    ...
    public static class TurretConstants {
        ...
        public static final Translation2d TURRET_OFFSET = new Translation2d(0.0, 0.0);// new Translation2d(-0.1518,
    ...
    public static class ClimbConstants {
        ...
        public static final double LEVEL_ONE_CLIMB_POSITION = -1.0; // Placeholder value, should be calibrated based on
                                                                    // the actual climb mechanism
        ...
        // Taken over from the duplicate climbConstants class
        public static final double LEFT_REEF_BRANCH_OFFSET = Units.inchesToMeters(11.5 / 2.0);
        public static final double RIGHT_REEF_BRANCH_OFFSET = Units.inchesToMeters(13.5 / 2.0);
        public static final double INTAKE_VOLTAGE = 0.5;
        public static final double OUTAKE_VOLTAGE = -0.5;
    }
